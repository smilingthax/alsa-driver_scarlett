...
#define HH_VERSION 1	/* FIXME: autodetection */
...
static int audio_dma_request(audio_stream_t *s, void (*callback)(void *, int))
{
	ret = sa1100_request_dma(s->dma_dev, s->id, audio_dma_callback, s, &s->dma_regs));
}
