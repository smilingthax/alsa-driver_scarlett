...
typedef  struct  sHPI_FORMAT {
        ...
        HW32    dwPadTo5;       /**< wMode, wSize removed*/
...
HPI_ERR HPI_API HPI_##object##_Get##name( \
...
{ return HPI_ControlParamGet(phSubSys, hControl, attribute, 0,0,(HW32 *)dwAttrValue, NULL); } \

#define fnHPI_Control_Set(object,name,attribute, type) \
HPI_ERR HPI_API HPI_##object##_Set##name( \
    HPI_HSUBSYS *phSubSys, HPI_HCONTROL hControl,type dwAttrValue \
);\
HPI_ERR HPI_API HPI_##object##_Set##name( \
    HPI_HSUBSYS *phSubSys, HPI_HCONTROL hControl,type dwAttrValue \
...
{ return HPI_ControlParamSet(phSubSys, hControl, attribute, (HW32)dwAttrValue, 0); } \
...
DEPRECATED HPI_ERR HPI_API HPI_Tuner_GetVideoStatus(                               /* AGE 11/10/97 */
                HPI_HSUBSYS     *phSubSys,
                HPI_HCONTROL    hControlHandle,
					 HW16            *pwVideoStatus
					 );
...
/****************************/
HPI_ERR HPI_API HPI_AESEBU_Receiver_SetSource(
                HPI_HSUBSYS     *phSubSys,
                HPI_HCONTROL    hControlHandle,
                HW16            wSource     /* HPI_AESEBU_SOURCE_AESEBU, HPI_AESEBU_SOURCE_SPDIF */
                );

HPI_ERR HPI_API HPI_AESEBU_Receiver_GetSource(   /* TFE apr-1-04 */
				HPI_HSUBSYS     *phSubSys,
				HPI_HCONTROL    hControlHandle,
...
HPI_ERR HPI_API HPI_AESEBU_Transmitter_SetClockSource(   /* SGT nov-4-98 */
				HPI_HSUBSYS     *phSubSys,
                HPI_HCONTROL    hControlHandle,
                HW16            wClockSource       /* SYNC, ADAPTER */
                );

HPI_ERR HPI_API HPI_AESEBU_Transmitter_GetClockSource(   /* TFE apr-1-04 */
				HPI_HSUBSYS     *phSubSys,
				HPI_HCONTROL    hControlHandle,
...
HPI_ERR HPI_API HPI_AESEBU_Transmitter_GetFormat(		/* TFE apr-1-04 */
				HPI_HSUBSYS     *phSubSys,
				HPI_HCONTROL    hControlHandle,
...
/*************************/
HPI_ERR HPI_API HPI_OnOffSwitch_SetState(
                 HPI_HSUBSYS     *phSubSys,
                 HPI_HCONTROL    hControlHandle,
                 HW16            wState                   /* 1=on, 0=off */
                );

HPI_ERR HPI_API HPI_OnOffSwitch_GetState(
                 HPI_HSUBSYS     *phSubSys,
                 HPI_HCONTROL    hControlHandle,
                 HW16            *wState                  /* 1=on, 0=off */
                );
...
*/
HPI_ERR HPI_API HPI_Cobranet_SetMode(
                HPI_HSUBSYS     *phSubSys,
                HPI_HCONTROL    hControlHandle,
                HW32  dwMode,
...
*/
HPI_ERR HPI_API HPI_Cobranet_GetMode(
                HPI_HSUBSYS     *phSubSys,
                HPI_HCONTROL    hControlHandle,
                HW32  *pdwMode
				);
...
fnHPI_Control_Get(ToneDetector,State,HPI_TONEDETECTOR_STATE,HW32)
fnHPI_Control_SetGet(ToneDetector,Enable,HPI_GENERIC_ENABLE,HW32)
fnHPI_Control_SetGet(ToneDetector,EventEnable,HPI_GENERIC_EVENT_ENABLE,HW32)
fnHPI_Control_SetGet(ToneDetector,Threshold,HPI_TONEDETECTOR_THRESHOLD,int)

HPI_ERR HPI_API HPI_ToneDetector_GetFrequency(
                HPI_HSUBSYS     *phSubSys,
...
*******************************/
fnHPI_Control_Get(SilenceDetector,State,HPI_SILENCEDETECTOR_STATE,HW32)

fnHPI_Control_SetGet(SilenceDetector,Enable,HPI_GENERIC_ENABLE,HW32)
fnHPI_Control_SetGet(SilenceDetector,EventEnable,HPI_GENERIC_EVENT_ENABLE,HW32)
fnHPI_Control_SetGet(SilenceDetector,Delay,HPI_SILENCEDETECTOR_DELAY,HW32)
fnHPI_Control_SetGet(SilenceDetector,Threshold,HPI_SILENCEDETECTOR_THRESHOLD,int)
...
#else
	HW32 *	apMemBase[HPI_MAX_ADAPTER_MEM_SPACES];
